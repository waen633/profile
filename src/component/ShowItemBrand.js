                ...
                <div className="row">
                    ...
                    {brand_all.map((element, index) => {
                        return <div className="col-lg-3">
                            {/* small box */}
                            <a href='#section1' className="small-box bg-secondary" onClick={() => this.filterAirport(element.item_brand, element.item_brand)}>
                                <div className="inner">
